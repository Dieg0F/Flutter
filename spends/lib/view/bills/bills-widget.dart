        ...
        builder: (BuildContext context, AsyncSnapshot<List<Bill>> snapshot) {
          if (snapshot.hasData) {
            if (snapshot.data.isNotEmpty) {
              ...
              return Center(
                child: basicText("snapshot.data.isEmpty", 35, Colors.black26),
              );
            }
          } else {
            return Center(
    ...
    return Container(
      child: Center(
        child: Column(
          ...
          children: <Widget>[
            Container(
              child: basicText("Total que gastei", 25, Colors.black26),
              padding: new EdgeInsetsDirectional.fromSTEB(0, 8, 0, 8),
            ),
            Container(
              child: basicText("R\$ ${total}", 35, Colors.red),
              padding: new EdgeInsetsDirectional.fromSTEB(0, 8, 0, 8),
            ),
          ],
        ),
      ...
      child: InkResponse(
        ...
        child: Container(
          child: Column(
            ...
            children: <Widget>[
              Container(
                child: basicText(bill.name, 18, Colors.black54),
                padding: new EdgeInsetsDirectional.fromSTEB(0, 8, 0, 0),
              ),
              Container(
                child: basicText(bill.where, 14, Colors.black26),
                padding: new EdgeInsetsDirectional.fromSTEB(0, 4, 0, 8),
              ),
              Container(
                child: basicText("R\$ ${bill.price}", 28, Colors.red),
                padding: new EdgeInsetsDirectional.fromSTEB(0, 8, 0, 8),
              ),
            ],
          ),
