...
class ImageOptions {
  ...
  Future<File> buildFinalImage(
    ...
    var wMarkImage = await loadWatermark();

    var dstXPosition = this.image.width - wMarkImage.width;
    var dstYPosition = this.image.heigth - wMarkImage.heigth;

    var imageComplete =
        imagePgk.copyInto(this.image, wMarkImage, dstX: 250, dstY: 250);
